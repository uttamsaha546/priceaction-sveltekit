...
import { MySeriesMarkersPaneRenderer } from './pane-renderer';
...
export class MySeriesMarkersPaneView implements IPrimitivePaneView {
	_source: MySeriesMarkersDataSource;
	_p1: ViewPoint = { x: null, y: null };
	_p2: ViewPoint = { x: null, y: null };

	constructor(source: MySeriesMarkersDataSource) {
		this._source = source;
	}
