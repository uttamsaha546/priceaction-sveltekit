...
abstract class MySeriesMarkersAxisView implements ISeriesPrimitiveAxisView {
	_source: MySeriesMarkersDataSource;
	_p: Point;
	_pos: Coordinate | null = null;
	constructor(source: MySeriesMarkersDataSource, p: Point) {
		this._source = source;
		this._p = p;
	}
...
export class MySeriesMarkersTimeAxisView extends MySeriesMarkersAxisView {
	update() {
...
export class MySeriesMarkersPriceAxisView extends MySeriesMarkersAxisView {
	update() {
